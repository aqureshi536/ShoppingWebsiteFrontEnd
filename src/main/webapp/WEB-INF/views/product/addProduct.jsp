...
<div class="panel-heading">Add Product</div>
	<div class="panel-body">
		<div class="row">
				...
				<form:form action="${contextPath}/admin/viewProducts" class="form-horizontal" commandName="Product" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label for="productCategory" class="control-label col-sm-2">Select
							Category</label>
						<div class="col-sm-10">
							<form:select path="categoryId" name="productCategory" id="" class="form-control" >
					...
					<div class="form-group">
						<label for="productSupplier" class="control-label col-sm-2">Product
							Supplier</label>
						<div class="col-sm-10">
							<form:select path="supplierId" name="productSupplier" id="" class="form-control">
					...
					<div class="form-group">
						<label for="productPrice" class="control-label col-sm-2">Product
							price</label>
						<div class="col-sm-10">
							<form:input path="price" type="text" pattern="^[0-9]+$" name="productPrice"	class="form-control"/>
					...
					<div class="form-group">
						<label for="productStock" class="control-label col-sm-2">Units
							Available</label>
						<div class="col-sm-10">
							<form:input path="quantity" type="text" pattern="^[0-9]+$" name="productStock"
								class="form-control"/>							
						</div>
					</div>
					<div class="form-group">
					...
					<div class="col-sm-10"><form:input type="file" path="imageUrl" class="form-control "/></div>
